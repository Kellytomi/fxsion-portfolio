...
const ContactInfoCard = ({ info }: { info: ContactInfo }) => {
  return (
    <motion.div
      ...
      className="relative p-6 rounded-xl overflow-hidden backdrop-blur-lg border border-white/10"
      style={{
        background: 'linear-gradient(145deg, rgba(147, 183, 190, 0.05), rgba(45, 48, 71, 0.1))',
    ...
    >
      ...
      <div className="relative flex items-start gap-4">
        <div className="p-3 rounded-lg bg-gradient-to-br from-primary/10 to-secondary/10 text-primary">
...
const SocialLink = ({ link }: { link: SocialLink }) => {
  return (
    <motion.a
      ...
      className={`p-4 rounded-full ${link.color} group relative overflow-hidden transition-all duration-300`}
    ...
    >
      ...
      <span className="relative text-white/90 group-hover:text-white transition-colors duration-300">
    ...
    <main className="min-h-screen bg-surface relative overflow-hidden">
      ...
      <section className="pt-32 pb-20 relative">
        <div className="container">
          ...
          >
            <h1 className="section-title mb-6 bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">
              Get in Touch
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="card p-8 backdrop-blur-lg bg-white/5 border border-white/10">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-secondary/5 rounded-xl" />
                <div className="relative">
                  <h2 className="display-text text-2xl mb-6 font-syne">Send a Message</h2>
